...
--]]
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      --    That is to say, every time a new file is opened that is associated with an lsp (for example, opening `main.rs` is associated with `rust_analyzer`) this
...
-- # user_transparent_background - function written by MuhammadHassanminhas @ GitHub
